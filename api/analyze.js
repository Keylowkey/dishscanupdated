      ...
      body: JSON.stringify({
        ...
        messages: [{
          ...
          content: [
            ...
            {
              type: 'text',
              text: 'You are a professional chef and nutritionist. Analyze this food image and respond ONLY with a raw JSON object — no markdown, no backticks, no explanation. Use exactly this structure: {"dish":"Full Dish Name","servings":2,"time":"30 min","difficulty":"Easy","dietary":"Vegetarian","calories":420,"ingredients":[{"emoji":"🍅","name":"Ingredient name","qty":"1 cup"}],"steps":["Detailed step one.","Detailed step two."],"swaps":[{"from":"Original ingredient","to":"Healthier alternative","saving":60}],"searchKeyword":"short keyword"} Provide 6-8 ingredients with accurate emojis, 4-6 detailed cooking steps, 3 calorie-reducing swaps that preserve flavor, accurate per-serving calorie estimate, and a 1-3 word searchKeyword.'
            }
          ]
        }]
      })
